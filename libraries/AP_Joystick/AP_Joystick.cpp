...
const AP_Param::GroupInfo AP_Joystick::var_info[] PROGMEM = {
    // @Param: ENABLED
    // @Display Name: Joystick Enabled
    // @Description: Boolean indicating whether joystick is active.
    // @Units: Boolean
    // @Range: 0 1
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("ENABLED", 0, AP_Joystick, _enabled, 0),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("FS_TIME", 1, AP_Joystick, _failsafe_timeout, 2),
    ...
    // @User: Advanced
    AP_GROUPINFO("FS_ACTION", 2, AP_Joystick, _failsafe_action, 1),
    ...
    // @Increment: 0.1
    // @User: Advanced
    AP_GROUPINFO("LINK_DELAY", 3, AP_Joystick, _mavlink_delay, 5.0f),
