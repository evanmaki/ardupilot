...
typedef enum MAV_CMD
{
	...
	MAV_CMD_DO_JOYSTICK_OPTIMIZED=189, /*  Mission command to postpone messaging traffic to allow joystick control. |Set joystick_optimized value| Empty| Empty| Empty| Empty| Empty| Empty|  */
